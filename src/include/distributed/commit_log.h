 ...
 */
    ...
    public:
         ...
         */
        inline static bool txnFail{false};
        inline static txn_id_t currTxnId{};
        std::map<txn_id_t, std::list<std::pair<block_id_t, block_id_t>>> txs;
        std::map<txn_id_t, bool> txnDone;
